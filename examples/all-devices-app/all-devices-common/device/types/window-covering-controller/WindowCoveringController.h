...
class WindowCoveringController : public SingleEndpoint
{
public:
    explicit WindowCoveringController(TimerDelegate & timerDelegate);
    ~WindowCoveringController() override = default;
